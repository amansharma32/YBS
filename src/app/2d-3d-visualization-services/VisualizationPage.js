...
export default function VisualizationPage() {
    ...
    const faqs = [
        ...
        {
            question: "What types of 2D and 3D visualization projects do you specialize in ?",
            answer: "We specialize in a wide range of 2D and 3D visualization projects, including stunning architectural renderings for real estate, photorealistic product mockups for marketing, and immersive virtual tours. Our services are ideal for businesses that need to visually present concepts, products, or spaces with a high degree of realism and detail."
        },

        {
            question: "How long does a typical 2D or 3D visualization project take ?",
            answer: "The timeline for a 2D or 3D visualization project is highly dependent on its complexity. A single photorealistic image may take a few days, while a detailed animation or a series of architectural renders for a large project could take several weeks. We provide a detailed timeline after our initial consultation phase."
        },

        {
            question: "What kind of input materials are needed to start a project ?",
            answer: "To begin your visualization project, we require all available input materials, such as blueprints, CAD files, sketches, and any reference images you have. We also need to understand your project goals and target audience. The more detailed the information you can provide upfront, the more efficiently we can move into the modeling and rendering stages."
        },



        {
            question: "How do you ensure our feedback is incorporated into the design ?",
            answer: "Our process is built on continuous collaboration. We'll share preliminary models and renders with you for feedback during the Review & Refinement stage. We work closely with you to incorporate your input and ensure the final product aligns perfectly with your vision before final delivery."
        },
       

        {
            question: "What file formats and assets will we receive at the end of the project ?",
            answer: "Upon your final approval, we deliver high-resolution image files (e.g., PNG, JPEG), video files (e.g., MP4), or interactive virtual tour files, depending on the scope. We also provide the final, rendered assets and source files as agreed upon in the initial consultation, giving you everything you need to showcase your project."
        },
  ...
  },
  {
    ...
    const webDevelopmentProcessSteps = [
        
       {
        ...
        content: "We begin by understanding your vision, target audience, and business goals. Our team conducts in-depth research into industry trends and competitors to develop a strategic plan that ensures your animated content is both captivating and effective.",
...

    {
        ...
        content: "This is where your ideas take visual form. We'll craft a compelling script and then create a detailed storyboard, a visual roadmap that outlines the flow, characters, and key scenes of your animation. This collaborative step ensures we're perfectly aligned before moving to production.",
...

    {
        ...
        content: "Our expert animators bring your vision to life. We specialize in both 2D and 3D animation, creating and styling all characters, objects, and environments. This phase involves intricate 3D modeling and adding color, texture, and style to every element for a truly unique look.",
...

    {
        ...
        content: "The final touches are applied here to create an immersive experience. We integrate professional voice-overs, captivating sound effects, and carefully selected music. Our team then performs the final rendering to deliver a polished, high-quality animation ready for any platform.",
...

    {
        ...
        content: "We provide your finished animation in the formats you need, ensuring it's optimized for your chosen channels. Our commitment extends to delivering the final product on time and within budget, with open communication and support throughout the entire project.",
                    ...
                    <div className="absolute w-full h-full p-9 bottom-0 flex flex-col md:flex-row justify-center md:justify-between items-center md:text-center mx-auto">
                        <p className="text-center font-sans md:text-left font-thin text-white text-2xl md:text-4xl flex flex-col justify-center items-center h-full my-auto">
                           2D / 3D Visualisation Services
                            <br />
                            <span className="text-center font-sans  text-[10px] md:text-[15px] pt-5 w-full md:text-start uppercase">Home /   2D / 3D Visualisation Services
                            </span>
                        </p>
                    </div>
                </div>
...
What sets our 2D / 3D visualization agency apart is our strategic approach. We begin with a deep dive into your project's identity, market, and target audience. Our team conducts extensive research and brainstorming sessions to develop innovative concepts that align with your business objectives. This phase is crucial for defining the visual language, style, and messaging, setting a solid foundation for every creative project. By meticulously planning each detail, we ensure the final output is not just a pretty picture, but a powerful tool that drives engagement and communicates your vision effectively.
