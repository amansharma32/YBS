...
import { ShieldCheck, Wifi, Cloud, Fingerprint, Server, Database, Laptop, Headphones } from 'lucide-react';
...
export default function CyberSecurity() {
 ...
 const webDevelopmentProcessSteps = [
  ...
  const services = [
  {
    ...
    description: "Our Managed Detection and Response (MDR) service provides advanced tools and expertise to defend your organization against cyber threats. We deliver comprehensive protection and rapid recovery capabilities, ensuring your business stays resilient.",
    icon: <ShieldCheck className="text-4xl text-sky-500" />
  },
  {
    title: "Network Security Management",
    description: "Through continuous Network Security Monitoring and Management, we optimize your system's performance and health. We proactively guard your network against external threats and deploy advanced intrusion detection to keep your business secure.",
    icon: <Wifi className="text-4xl text-sky-500" />
  },
  {
    title: "Cloud Security",
    description: "Our Cloud Security services are designed to secure your digital transformation. We implement robust strategies, policies, and compliance measures to protect your IT infrastructure and sensitive data, enabling you to innovate with confidence.",
    icon: <Cloud className="text-4xl text-sky-500" />
  },
  {
    title: "Identity & Access Management",
    description: "With our Identity and Access Management (IAM) solutions, we control who can access your organization's resources. We enforce strict authentication, authorization, and privilege management to ensure only authorized users can access sensitive information.",
    icon: <Fingerprint className="text-4xl text-sky-500" />
  },
  {
    title: "Server Security",
    description: "Our Server Security and Hardening services secure your servers against cyberattacks. We minimize potential entry points for unauthorized intruders by optimizing and fortifying the server operating system to prevent unauthorized access.",
    icon: <Server className="text-4xl text-sky-500" />
  },
  {
    title: "Database Hardening",
    description: "Database Hardening involves analyzing and configuring your databases to reduce security vulnerabilities. We implement a structured approach, including encryption, robust password policies, and strict access controls, to protect your critical data.",
    icon: <Database className="text-4xl text-sky-500" />
  },
  {
    title: "Web & Mobile App Security",
    description: "Our Web and Mobile App Security Testing services analyze applications for potential flaws. We use the latest tools and technologies to detect complex threat vectors and take proactive measures to minimize your risk.",
    icon: <Laptop className="text-4xl text-sky-500" />
  },
  {
    title: "Technical Support",
    description: "We provide End-to-End Technical Support to help you implement and maintain the best cyber security practices across your organization. Our comprehensive support includes assistance with installation, setup, software and hardware management, and network/data storage management.",
    icon: <Headphones className="text-4xl text-sky-500" />
  },
];
          ...
          <div className="absolute w-full h-full p-9 bottom-0 flex flex-col md:flex-row justify-center md:justify-between items-center md:text-center mx-auto">
            <p className="text-center  md:text-left font-thin text-white text-2xl md:text-4xl flex flex-col justify-center items-center h-full my-auto">
              ...
              <span className="text-center   text-[10px] md:text-[15px] pt-5 w-full md:text-start uppercase">
                Technology / Cyber Security Services              </span>
            </p>
          </div>
        </div>
      </section>
            ...
            <div className=" blog-img mb-6 text-center">
              <div className="flex gap-4 md:gap-9  justify-evenly items-center  flex-col md:flex-row">
                ...
                Technology
                    ...
                    Why Our Cyber Security Services Stand Out
...
Our services are designed to proactively identify and neutralize critical vulnerabilities and threats long before they can impact your business. This forward-thinking strategy not only protects your brand's reputation but also saves you significant time and resources by addressing security risks at the earliest stages of development, preventing costly data breaches and operational downtime.
...
Beyond simply detecting vulnerabilities, our team focuses on implementing proactive threat intelligence and risk management to ensure your entire digital ecosystem is secure. We meticulously analyze every entry point and user flow to guarantee your data is protected, which builds customer trust and maintains business continuity. We seamlessly integrate our security processes into your development pipeline. By embedding continuous security checks and automated testing into your CI/CD pipelines, we ensure that every code change is validated for security. This approach minimizes risks, fortifies your overall security posture, and enables faster, more secure product releases.
                  </p>
