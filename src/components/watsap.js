...
const WatsapButton = ({ phoneNumber }) => {
    ...
    return (
        <div className="fixed bottom-4 group transition-all duration-500 hover:-translate-y-2 right-4 z-50">
            ...
            <div className="hidden fixed bottom-14 right-4 bg-white p-4 rounded-lg shadow-lg">

                <textarea
                    value={message}
                    onChange={(e) => setMessage(e.target.value)}
                    placeholder="Type your message here..."
                    className="w-full p-2 mb-2 border border-gray-300 rounded-md resize-none"
                    rows="4"
                />
